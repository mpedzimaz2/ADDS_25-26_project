...
Approach
Retrieve posts and vote metadata through the Wykop API

Clean, transform and join data in pandas

Create user-level features covering voting volume, vote direction, activity time, voting reasons and topic patterns

Explore outliers using Python and Orange Data Mining
...
Add your Wykop API credentials locally — never commit API keys or secrets
